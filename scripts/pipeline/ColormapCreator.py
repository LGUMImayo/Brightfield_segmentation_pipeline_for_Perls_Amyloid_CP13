...
SCALE_FILE = 'heatmap_{}_res10_scale.npy'
...
class ColormapCreator(object):
    ...
    def get_dirs_to_process(self,root_dir):
        """
        Get directories to process for colormap creation.
        
        If root_dir is a *_files directory (contains heatmap/hm_map_*), 
        ...
        hm_map_dirs = glob_module.glob(os.path.join(root_dir, 'heatmap', 'hm_map_*'))
        if hm_map_dirs:
    ...
    def run_compute_colormap(self,slice_dir):
        ...
        # FIX: 'heatmap' directory (was 'heat_map')
        hm_dir = os.path.join(slice_dir, 'heatmap/hm_map_' + str(self.HMAP_RES))
        
        # NOTE: Filename format 'heat_map_...' corresponds to HeatmapCreator output
        res10_hm_file = os.path.join(hm_dir,'heat_map_'+str(self.HMAP_RES)+'_res10.npy')
        
        # FIX: 'heatmap' directory (was 'heat_map')
        cmap_dir = os.path.join(slice_dir, 'heatmap/color_map_' + str(self.HMAP_RES))
